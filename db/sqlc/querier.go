...
type Querier interface {
	...
	CreatePostLike(ctx context.Context, arg CreatePostLikeParams) (Like, error)
	CreateSession(ctx context.Context, arg CreateSessionParams) (Session, error)
	CreateUser(ctx context.Context, arg CreateUserParams) (uuid.UUID, error)
	CreateUserIdentity(ctx context.Context, arg CreateUserIdentityParams) (UserIdentity, error)
	DeleteComment(ctx context.Context, id uuid.UUID) (Comment, error)
	DeleteCommentLike(ctx context.Context, arg DeleteCommentLikeParams) (CommentLike, error)
	...
	ListAllCommentLikes(ctx context.Context, commentID uuid.UUID) ([]CommentLike, error)
	ListAllComments(ctx context.Context, postID uuid.UUID) ([]Comment, error)
	ListAllPostLikes(ctx context.Context, postID uuid.UUID) ([]Like, error)
